...
export let ListboxLabel = defineComponent({
  ...
  props: {
    ...
    id: { type: String, default: () => `eslamdevui-listbox-label-${useId()}` },
  },
...
export let ListboxButton = defineComponent({
  ...
  props: {
    ...
    id: { type: String, default: () => `eslamdevui-listbox-button-${useId()}` },
  },
...
export let ListboxOptions = defineComponent({
  ...
  props: {
    ...
    id: { type: String, default: () => `eslamdevui-listbox-options-${useId()}` },
  },
  setup(props, { attrs, slots, expose }) {
...
export let ListboxOption = defineComponent({
  ...
  props: {
    ...
    disabled: { type: Boolean, default: false },
    id: { type: String, default: () => `eslamdevui-listbox.option-${useId()}` },
  },
