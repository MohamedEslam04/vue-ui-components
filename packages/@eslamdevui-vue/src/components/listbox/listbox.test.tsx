  ...
  it(
    ...
    suppressConsoleLogs(async () => {
      ...
      assertListboxButton({
        ...
        attributes: { id: 'eslamdevui-listbox-button-1' },
      })
  ...
  describe('ListboxLabel', () => {
    it(
      ...
      suppressConsoleLogs(async () => {
        ...
        assertListboxButton({
          state: ListboxState.InvisibleUnmounted,
          attributes: { id: 'eslamdevui-listbox-button-2' },
        })
        assertListboxLabel({
          attributes: { id: 'eslamdevui-listbox-label-1' },
  ...
  describe('`Enter` key', () => {
    it(
      ...
      suppressConsoleLogs(async () => {
        ...
        assertListbox({
          state: ListboxState.Visible,
          attributes: { id: 'eslamdevui-listbox-options-2' },
        })
        assertActiveElement(getListbox())
        assertListboxButtonLinkedWithListbox()
