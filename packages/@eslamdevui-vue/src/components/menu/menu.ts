...
export let MenuButton = defineComponent({
  ...
  props: {
    ...
    id: { type: String, default: () => `eslamdevui-menu-button-${useId()}` },
  },
...
export let MenuItems = defineComponent({
  ...
  props: {
    ...
    id: { type: String, default: () => `eslamdevui-menu-items-${useId()}` },
  },
  setup(props, { attrs, slots, expose }) {
...
export let MenuItem = defineComponent({
  ...
  props: {
    ...
    disabled: { type: Boolean, default: false },
    id: { type: String, default: () => `eslamdevui-menu-item-${useId()}` },
  },
