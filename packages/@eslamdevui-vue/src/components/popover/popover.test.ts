  ...
  it(
    ...
    suppressConsoleLogs(async () => {
      ...
      assertPopoverButton({
        ...
        attributes: { id: 'eslamdevui-popover-button-1' },
      })
  ...
  describe('`Enter` key', () => {
    it(
      ...
      suppressConsoleLogs(async () => {
        ...
        assertPopoverPanel({
          state: PopoverState.Visible,
          attributes: { id: 'eslamdevui-popover-panel-3' },
        })
    ...
    suppressConsoleLogs(async () => {
      ...
      assertPopoverPanel(
        ...
        document.querySelector(
          '[data-testid="popover-a"] [id^="eslamdevui-popover-panel-"]'
        ) as HTMLElement
      )
      ...
      assertPopoverPanel(
        { state: PopoverState.InvisibleUnmounted },
        document.querySelector(
          '[data-testid="popover-b"] [id^="eslamdevui-popover-panel-"]'
        ) as HTMLElement
      )
