...
export function getComboboxLabel(): HTMLElement | null {
  return document.querySelector('label,[id^="eslamdevui-combobox-label"]')
}
...
export function getListboxLabel(): HTMLElement | null {
  return document.querySelector('label,[id^="eslamdevui-listbox-label"]')
}
...
export function getSwitchLabel(): HTMLElement | null {
  return document.querySelector('label,[id^="eslamdevui-switch-label"]')
}
...
export function getPopoverOverlay(): HTMLElement | null {
  return document.querySelector('[id^="eslamdevui-popover-overlay-"]')
}
...
export function getDialogOverlay(): HTMLElement | null {
  return document.querySelector('[id^="eslamdevui-dialog-overlay-"]')
}

export function getDialogBackdrop(): HTMLElement | null {
  return document.querySelector('[id^="eslamdevui-dialog-backdrop-"]')
}

export function getDialogOverlays(): HTMLElement[] {
  return Array.from(document.querySelectorAll('[id^="eslamdevui-dialog-overlay-"]'))
}
...
export function getRadioGroupLabel(): HTMLElement | null {
  return document.querySelector('[id^="eslamdevui-label-"]')
}
