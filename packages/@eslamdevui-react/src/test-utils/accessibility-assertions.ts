...
export function getLabel(): HTMLElement | null {
  return document.querySelector('label,[id^="eslamdevui-label-"]')
}

export function getLabels(): HTMLElement[] {
  return Array.from(document.querySelectorAll('label,[id^="eslamdevui-label-"]'))
}

export function getDescription(): HTMLElement | null {
  return document.querySelector('[id^="eslamdevui-description-"]')
}

export function getDescriptions(): HTMLElement[] {
  return Array.from(document.querySelectorAll('[id^="eslamdevui-description-"]'))
}

export function getControl(): HTMLElement | null {
  return document.querySelector('[id^="eslamdevui-control-"]')
}
...
export function getMenuButton(): HTMLElement | null {
  return document.querySelector('button,[role="button"],[id^="eslamdevui-menu-button-"]')
}
...
export function getComboboxLabel(): HTMLElement | null {
  return document.querySelector('label,[id^="eslamdevui-combobox-label"],[id^="eslamdevui-label"]')
}

export function getComboboxButton(): HTMLElement | null {
  return document.querySelector('button,[role="button"],[id^="eslamdevui-combobox-button-"]')
}
...
export function getListboxLabel(): HTMLElement | null {
  return document.querySelector('label,[id^="eslamdevui-listbox-label"],[id^="eslamdevui-label"]')
}

export function getListboxButton(): HTMLElement | null {
  return document.querySelector('button,[role="button"],[id^="eslamdevui-listbox-button-"]')
}
...
export function getSwitchLabel(): HTMLElement | null {
  return document.querySelector('label,[id^="eslamdevui-switch-label"],[id^="eslamdevui-label"]')
}
...
export function getDisclosureButton(): HTMLElement | null {
  return document.querySelector('[id^="eslamdevui-disclosure-button-"]')
}

export function getDisclosurePanel(): HTMLElement | null {
  return document.querySelector('[id^="eslamdevui-disclosure-panel-"]')
}
...
export function getPopoverButton(): HTMLElement | null {
  return document.querySelector('[id^="eslamdevui-popover-button-"]')
}

export function getPopoverPanel(): HTMLElement | null {
  return document.querySelector('[id^="eslamdevui-popover-panel-"]')
}

export function getPopoverOverlay(): HTMLElement | null {
  return document.querySelector('[id^="eslamdevui-popover-backdrop-"]')
}
...
export function getDialogTitle(): HTMLElement | null {
  return document.querySelector('[id^="eslamdevui-dialog-title-"]')
}
...
export function getRadioGroupOptions(): HTMLElement[] {
  return Array.from(document.querySelectorAll('[id^="eslamdevui-radiogroup-option-"]'))
}
...
export function getTabs(): HTMLElement[] {
  return Array.from(document.querySelectorAll('[id^="eslamdevui-tabs-tab-"]'))
}

export function getPanels(): HTMLElement[] {
  return Array.from(document.querySelectorAll('[id^="eslamdevui-tabs-panel-"]'))
}
...
export function assertTabs(
  ...
  try {
    ...
    let activeTab = Array.from(list.querySelectorAll('[id^="eslamdevui-tabs-tab-"]'))[active]
