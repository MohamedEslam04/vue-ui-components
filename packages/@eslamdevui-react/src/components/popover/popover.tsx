...
function ButtonFn<TTag extends ElementType = typeof DEFAULT_BUTTON_TAG>(
  ...
  let {
    id = `eslamdevui-popover-button-${internalId}`,
    disabled = false,
    autoFocus = false,
    ...theirProps
  } = props
  ...
  //
  // ```js
  // ['eslamdevui-popover-button-undefined', 'eslamdevui-popover-button-1']
  // ```
  //
...
function BackdropFn<TTag extends ElementType = typeof DEFAULT_BACKDROP_TAG>(
  ...
  let internalId = useId()
  let {
    id = `eslamdevui-popover-backdrop-${internalId}`,
    transition = false,
    ...theirProps
  } = props
...
function PanelFn<TTag extends ElementType = typeof DEFAULT_PANEL_TAG>(
  ...
  let internalId = useId()
  let {
    id = `eslamdevui-popover-panel-${internalId}`,
    focus = false,
    anchor: rawAnchor,
    portal = false,
    modal = false,
  ...
  let beforePanelSentinelId = `eslamdevui-focus-sentinel-before-${internalId}`
  let afterPanelSentinelId = `eslamdevui-focus-sentinel-after-${internalId}`
      ...
      match(direction.current, {
        [TabDirection.Forwards]: () => {
          ...
          for (let element of combined.slice()) {
            if (
              element.dataset.eslamdevuiFocusGuard === 'true' ||
