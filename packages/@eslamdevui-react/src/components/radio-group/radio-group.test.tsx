...
describe('Rendering', () => {
  ...
  it(
    ...
    suppressConsoleLogs(async () => {
      ...
      expect(options[0]).toHaveAttribute('data-eslamdevui-state', '')
      expect(options[1]).toHaveAttribute('data-eslamdevui-state', '')
      expect(options[2]).toHaveAttribute('data-eslamdevui-state', '')

      // Focus the RadioGroup
      await press(Keys.Tab)

      // The first one should be active, but not checked yet
      expect(options[0]).toHaveAttribute('data-eslamdevui-state', 'active focus')
      expect(options[1]).toHaveAttribute('data-eslamdevui-state', '')
      expect(options[2]).toHaveAttribute('data-eslamdevui-state', '')
      ...
      expect(options[0]).toHaveAttribute('data-eslamdevui-state', 'checked active focus')
      expect(options[1]).toHaveAttribute('data-eslamdevui-state', '')
      expect(options[2]).toHaveAttribute('data-eslamdevui-state', '')
      ...
      expect(options[0]).toHaveAttribute('data-eslamdevui-state', '')
      expect(options[1]).toHaveAttribute('data-eslamdevui-state', 'checked active focus')
      expect(options[2]).toHaveAttribute('data-eslamdevui-state', '')
    })
  )
