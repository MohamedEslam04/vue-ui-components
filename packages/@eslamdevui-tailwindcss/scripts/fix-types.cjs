 ...
 * `@eslamdevui/tailwindcss` plugin has to compile to a CommonJs file. This works great, however
 ...
 * exported type. This allows us to use the `@eslamdevui/tailwindcss` plugin and have types in a
